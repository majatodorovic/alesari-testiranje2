...
import { post } from "../../../../OneDrive - Croonus Technologies DOO/pazari-shop-b2c/api/api";
import Link from "next/link";
import back from "../../../../OneDrive - Croonus Technologies DOO/pazari-shop-b2c/assets/Icons/right-chevron.png";
import hide from "../../../../OneDrive - Croonus Technologies DOO/pazari-shop-b2c/assets/Icons/hide-password.png";
import show from "../../../../OneDrive - Croonus Technologies DOO/pazari-shop-b2c/assets/Icons/show-password.png";
...
const ResetPasswordComponent = ({ token }) => {
  ...
  return (
    <div className="mt-[0rem] lg:mt-[9rem] mb-[6rem] mx-auto w-[90%] flex">
      <div>
        <Link href="/nalog">
