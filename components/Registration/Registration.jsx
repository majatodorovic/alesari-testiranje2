...
const Registration = ({ setIsReg }) => {
  ...
  const errorCheck = "You must accept the terms";
  return (
    <>
      <div className="h-[100%] flex flex-col items-center">
        <div className="loginHolder lg:w-[74%] max-lg:w-[90%] max-sm:w-[94%]">
          ...
          <p className="mb-[2rem] mt-[0.4rem] font-light text-[#4b4b4b]">
            By clicking the "Sign Up" button, you enter the registration process.
          </p>
          <p className="font-light text-[#4b4b4b]">
            Having an account allows you to checkout faster, create multiple shipping addresses, and track your orders.
          </p>
          <Button
            onClick={handleRegOpen}
            className="text-white py-[0.7rem] px-[1.3rem] text-sm mt-[2rem] hover:bg-opacity-70"
          >
            SIGN UP
          </Button>
          ...
          >
            ...
            >
                ...
                <form className="mt-4 grid sm:grid-cols-2 gap-x-10 pb-4 max-xl:text-base ">
                  ...
                  <div className=" flex sm:gap-3 sm:py-3 relative flex-col max-sm:mt-[2rem]">
                    <div className="termsAgree flex items-center">
                      ...
                      >
                        I agree with Alesari privacy policy.
                      </label>
                    </div>
              ...
              <Button
                ...
                className="text-white py-[0.7rem] px-[1.3rem] text-sm hover:bg-opacity-70 w-fit ml-auto"
              >
                {loading ? (
