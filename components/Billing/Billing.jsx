...
const Billing = () => {
  ...
  useEffect(() => {
    const fetchCustomerData = async() => {
        const fetchCustomerData = await get(`/customers/billing-address/${id}`).then(
            (response) => {
        ...
        const changeInputHandler = () => {
          ...
          set_default: data?.set_default
            ...
            post("/customers/billing-address", ret)
              .then((response) => {
                setDisabled(true)
          response?.code === 200 ? toast.success("Uspešno ste izmenili podatke.", {
            position: "top-center",
            autoClose: 3000,
            ...
            draggable: true,
            progress: undefined,
          }) : toast.error("Došlo je do nepoznate greške prilikom čuvanja podataka. Molimo pokušajte ponovo.", {
            position: "top-center",
            autoClose: 3000,
            hideProgressBar: false,
            closeOnClick: true,
    ...
    return (
        <>
            <div className='relative'>
                <button className='bg-croonus-3 p-[0.4rem] sm:mr-[4rem] max-sm:mr-[0.6rem] ml-[1re] rounded-[50%] mt-[0.5rem] hover:translate-y-0.5 transition-all ease cursor-pointer text-white min-w-[2.2rem] absolute md:top-4 md:left-4' onClick={handleGoBack}>
                    <Image
                    src={back}
                    alt="back button"
            ...
            <div>
              <div className='bg-[#f8f8f8] rounded-lg p-[1.4rem] md:w-[70%] mb-[3rem]'>
                  ...
                  <h3 className="text-base text-[#919191] font-normal max-sm:ml-[4rem]">&#62; Detalji adrese</h3>
                  </div>
                <div>
                    ...
                    <div className="flex flex-col gap-2">
                            ...
                            <select
                                    ...
                                    disabled={disabled}                                    id="customer_type"
                                    onChange={formChangeHandler}
                                    name="customer_type"
                                >
                    ...
                    <div className="termsAgree flex items-center md:w-[70%]">
                        <input
                            ...
                            className="focus:ring-0 focus:border-none focus:outline-none text-green-500 bg-[#191919] mr-[0.4rem] rounded-sm"
                        />
                        <label
                            htmlFor="set_default"
                ...
                <div>
                    ...
                    <div className="mt-4">
                        <button onClick={() => setDisabled(false)} className="bg-croonus-3 text-white py-[0.8rem] px-[2rem] hover:bg-opacity-80 mr-4">Izmena informacija</button>
                        <button onClick={changeInputHandler}  className="bg-black text-white py-[0.8rem] px-[2rem] hover:bg-opacity-80">Sačuvaj izmene</button>
                     </div>
                </div>
