...
const Shipping = () => {
    ...
    const fetchCustomerData = async() => {
        const fetchCustomerData = await get(`/customers/shipping-address/${id}`).then(
            (response) => {
                ...
                <div>
                    ...
                    <div className="termsAgree flex items-center md:w-[70%]">
                        <input
                            ...
                            className="focus:ring-0 focus:border-none focus:outline-none bg-[#191919] text-green-500 mr-[0.4rem] rounded-sm"
                        />
                        <label
                            htmlFor="set_default"
