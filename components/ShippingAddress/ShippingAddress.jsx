            ...
            <>
             ...
             <tr className={`divide-x divide-white ${index % 2 !== 0 ? "bg-[#ededed]" : "bg-croonus-gray"}`}>
                ...
                <td className=" md:pl-[1.4rem] py-[0.7rem] max-sm:text-sm pl-[0.4rem]">
                    <Link href={`/customer-shipping/${address?.id}`} className="max-sm:text-sm">Pogledaj više</Link>
                </td>
                
                <td className=" sm:pl-[2rem] py-[0.7rem] pl-[0.4rem]">
                    <div className='flex'>
                    <Link href={`/customer-shipping/${address?.id}`} className=' mr-[0.8rem] hover:translate-y-0.5 transition-all ease cursor-pointer'>
                    <Image
                    src={pen}
                    alt="change address"
                    width={22}
