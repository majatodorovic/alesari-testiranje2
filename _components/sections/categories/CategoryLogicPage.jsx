...
import { list, post } from "@/_api/api";

import Thumb from "@/_components/product/Thumb";
import Filters from "./Filters";

const CategoryLogicPage = ({ singleCategory }) => {
      ...
      <div className="">
        ...
        >
          {tempSelectedFilters?.map((filter) => {
            ...
            return (
              <div
                className={`bg-croonus-2 relative  flex items-center gap-2 rounded-lg  text-[0.65rem] font-normal text-white max-md:text-[0.7rem]`}
              >
                ...
                <div
                  ...
                  className={`bg-croonus-2 right-0  flex h-full flex-1 cursor-pointer  flex-col items-center justify-center self-stretch rounded-r-lg`}
                >
                  <i
...
export default CategoryLogicPage;
